    ...
    return (
        <footer>
            ...
            {page === 1 ? (
                ...
                <Link href={`?page=${prevPage}`} area-label='Previous Page'  className="inline-flex h-10 min-w-10 justify-center items-center bg-blue-500 px-4 rounded-full text-white">Prev</Link>
            )}
            ...
            {[...Array(totalPages)].map((_, index) => {
                ...
                // Render '...' only for the second and second-to-last pages
                return (
            ...
            {page === totalPages ? (
                ...
                <Link href={`?page=${nextPage}`} area-label='Next Page' className="inline-flex h-10 min-w-10 justify-center items-center bg-blue-500 px-4 rounded-full text-white">Next</Link>
            )}
            </nav>
        </footer>
    )
